...
export const MOCK_ASSETS: Asset[] = [
  { id: 'asset-1', name: '主角-林风', type: 'character', mimeType: 'image/png', size: 2048000, url: '/gallery-sample-1.jpg', thumbnail: '/gallery-sample-1.jpg', width: 1024, height: 1024, tags: ['角色', '古风', '男性'], usageCount: 12, createdAt: '2026-05-20T08:00:00Z' },
  { id: 'asset-2', name: '女主角-苏雪', type: 'character', mimeType: 'image/png', size: 1892000, url: '/gallery-sample-2.jpg', thumbnail: '/gallery-sample-2.jpg', width: 1024, height: 1024, tags: ['角色', '现代', '女性'], usageCount: 8, createdAt: '2026-05-19T10:00:00Z' },
  { id: 'asset-3', name: '樱花街道背景', type: 'background', mimeType: 'image/jpeg', size: 4096000, url: '/gallery-sample-3.jpg', thumbnail: '/gallery-sample-3.jpg', width: 1920, height: 1080, tags: ['背景', '日式', '樱花'], usageCount: 5, createdAt: '2026-05-18T14:00:00Z' },
  { id: 'asset-4', name: '魔法杖道具', type: 'prop', mimeType: 'image/png', size: 512000, url: '/gallery-sample-1.jpg', thumbnail: '/gallery-sample-1.jpg', width: 512, height: 512, tags: ['道具', '魔法', '武器'], usageCount: 3, createdAt: '2026-05-15T09:00:00Z' },
  { id: 'asset-5', name: '雨夜都市', type: 'background', mimeType: 'image/jpeg', size: 3500000, url: '/gallery-sample-2.jpg', thumbnail: '/gallery-sample-2.jpg', width: 1920, height: 1080, tags: ['背景', '都市', '夜景'], usageCount: 7, createdAt: '2026-05-10T16:00:00Z' },
  { id: 'asset-6', name: '战斗音效包', type: 'audio', mimeType: 'audio/wav', size: 8192000, url: '/gallery-sample-3.jpg', duration: 120, tags: ['音效', '战斗', '动作'], usageCount: 2, createdAt: '2026-05-05T11:00:00Z' },
]
...
export const MOCK_SCENES: Scene[] = [
  {
    ...
    latestResultUrl: '/gallery-sample-1.jpg', latestResultThumbnail: '/gallery-sample-1.jpg',
  ...
  },
  {
    ...
    assetIds: ['asset-1', 'asset-2', 'asset-5'],
    latestResultUrl: '/gallery-sample-2.jpg', latestResultThumbnail: '/gallery-sample-2.jpg',
  ...
  },
  {
    ...
    latestResultUrl: '/gallery-sample-3.jpg', latestResultThumbnail: '/gallery-sample-3.jpg',
...
export const MOCK_GENERATION_JOBS: GenerationJob[] = [
  {
    ...
    results: [{ id: 'res-1', sceneId: 'scene-1', url: '/gallery-sample-1.jpg', thumbnail: '/gallery-sample-1.jpg' }],
  },
  {
    ...
    results: [{ id: 'res-2', sceneId: 'scene-2', url: '/gallery-sample-2.jpg', thumbnail: '/gallery-sample-2.jpg' }],
  },
  {
  ...
  },
  {
    ...
    results: [{ id: 'res-4', url: '/gallery-sample-3.jpg', thumbnail: '/gallery-sample-3.jpg' }],
  },
]

export const MOCK_COMMUNITY_WORKS: CommunityWork[] = [
  { id: 'cw-1', userId: 'user-1', sourceType: 'generation', sourceId: 'job-1', title: '雨中决斗', description: '古风悬疑短片片段', workType: 'video', mediaUrl: '/gallery-sample-1.jpg', thumbnailUrl: '/gallery-sample-1.jpg', tags: ['古风', '悬疑', '动作'], userName: '张小明', userAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=1', createdAt: '2026-05-28T12:00:00Z' },
  { id: 'cw-2', userId: 'user-2', sourceType: 'generation', sourceId: 'job-2', title: '魔法战场', description: '奇幻魔法对决', workType: 'video', mediaUrl: '/gallery-sample-2.jpg', thumbnailUrl: '/gallery-sample-2.jpg', tags: ['奇幻', '战斗', '魔法'], userName: '李创意', userAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=2', createdAt: '2026-05-27T15:00:00Z' },
  { id: 'cw-3', userId: 'user-3', sourceType: 'generation', sourceId: 'job-4', title: '樱花下的约定', description: '青春校园爱情故事', workType: 'video', mediaUrl: '/gallery-sample-3.jpg', thumbnailUrl: '/gallery-sample-3.jpg', tags: ['校园', '浪漫', '治愈'], userName: '王视频', userAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=3', createdAt: '2026-05-26T10:00:00Z' },
  { id: 'cw-4', userId: 'user-4', sourceType: 'generation', sourceId: 'job-5', title: '暗夜追逐', description: '赛博朋克风格的追逐戏', workType: 'video', mediaUrl: '/gallery-sample-1.jpg', thumbnailUrl: '/gallery-sample-1.jpg', tags: ['科幻', '赛博朋克', '动作'], userName: '创作者A', userAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=4', createdAt: '2026-05-25T08:00:00Z' },
  { id: 'cw-5', userId: 'user-5', sourceType: 'generation', sourceId: 'job-6', title: '魔法少女变身', description: '经典变身场景', workType: 'video', mediaUrl: '/gallery-sample-2.jpg', thumbnailUrl: '/gallery-sample-2.jpg', tags: ['魔法', '变身', '少女心'], userName: '创作者B', userAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=5', createdAt: '2026-05-24T14:00:00Z' },
  { id: 'cw-6', userId: 'user-6', sourceType: 'generation', sourceId: 'job-7', title: '校园日常', description: '温馨的校园生活片段', workType: 'video', mediaUrl: '/gallery-sample-3.jpg', thumbnailUrl: '/gallery-sample-3.jpg', tags: ['校园', '日常', '治愈'], userName: '创作者C', userAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=6', createdAt: '2026-05-23T11:00:00Z' },
  { id: 'cw-7', userId: 'user-7', sourceType: 'generation', sourceId: 'job-8', title: '赛博朋克城市', description: '未来都市全景', workType: 'image', mediaUrl: '/gallery-sample-1.jpg', thumbnailUrl: '/gallery-sample-1.jpg', tags: ['科幻', '赛博朋克', '场景'], userName: '创作者D', userAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=7', createdAt: '2026-05-22T16:00:00Z' },
  { id: 'cw-8', userId: 'user-8', sourceType: 'generation', sourceId: 'job-9', title: '古风仙侠', description: '仙侠世界风景', workType: 'image', mediaUrl: '/gallery-sample-2.jpg', thumbnailUrl: '/gallery-sample-2.jpg', tags: ['古风', '仙侠', '风景'], userName: '创作者E', userAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=8', createdAt: '2026-05-21T09:00:00Z' },
  { id: 'cw-9', userId: 'user-9', sourceType: 'generation', sourceId: 'job-10', title: '机甲大战', description: '巨型机甲对决', workType: 'video', mediaUrl: '/gallery-sample-3.jpg', thumbnailUrl: '/gallery-sample-3.jpg', tags: ['科幻', '机甲', '战斗'], userName: '创作者F', userAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=9', createdAt: '2026-05-20T13:00:00Z' },
  { id: 'cw-10', userId: 'user-10', sourceType: 'generation', sourceId: 'job-11', title: '海底世界', description: '奇幻海底探险', workType: 'video', mediaUrl: '/gallery-sample-1.jpg', thumbnailUrl: '/gallery-sample-1.jpg', tags: ['奇幻', '海洋', '探险'], userName: '创作者G', userAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=10', createdAt: '2026-05-19T10:00:00Z' },
  { id: 'cw-11', userId: 'user-11', sourceType: 'generation', sourceId: 'job-12', title: '太空歌剧', description: '星际战争场景', workType: 'video', mediaUrl: '/gallery-sample-2.jpg', thumbnailUrl: '/gallery-sample-2.jpg', tags: ['科幻', '太空', '战争'], userName: '创作者H', userAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=11', createdAt: '2026-05-18T15:00:00Z' },
  { id: 'cw-12', userId: 'user-12', sourceType: 'generation', sourceId: 'job-13', title: '异世界冒险', description: '勇者小队出发', workType: 'comic', mediaUrl: '/gallery-sample-3.jpg', thumbnailUrl: '/gallery-sample-3.jpg', tags: ['奇幻', '冒险', '热血'], userName: '创作者I', userAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=12', createdAt: '2026-05-17T11:00:00Z' },
]
