...
export const MOCK_ASSETS: Asset[] = [
  ...
  { id: 'asset-scene-image-1', name: '樱花街道图片场景', type: 'scene', sceneKind: 'image', mimeType: 'image/webp', size: 4096000, url: assetUrl('demo-art/sakura-street.webp'), thumbnail: assetUrl('demo-art/sakura-street.webp'), width: 1672, height: 941, tags: ['场景', '图片场景', '樱花'], usageCount: 5, createdAt: '2026-05-09T11:00:00Z' },
  { id: 'asset-scene-3d-1', name: '竹林伏击 3D 编辑场景', type: 'scene', sceneKind: 'editable3d', mimeType: 'application/x-comic-market-scene+json', size: 24576, url: assetUrl('demo-art/xianxia-clouds.webp'), thumbnail: assetUrl('demo-art/xianxia-clouds.webp'), width: 1672, height: 941, tags: ['场景', '3D编辑', '竹林'], usageCount: 4, createdAt: '2026-05-09T09:00:00Z' },
  { id: 'asset-scene-preview-1', name: '雨夜追逐分镜 3D 预览', type: 'scene', sceneKind: 'imageToStoryboard3d', mimeType: 'application/x-comic-market-scene-preview+json', size: 32768, url: assetUrl('demo-art/rainy-cyber-street.webp'), thumbnail: assetUrl('demo-art/rainy-cyber-street.webp'), width: 1672, height: 941, tags: ['场景', '图片转分镜', '3D预览'], usageCount: 3, createdAt: '2026-05-08T18:00:00Z' },
